...
import { SelecaoIntegrantesComponent } from './features/musicas/pages/selecao-integrantes/selecao-integrantes.component';
...
export const routes: Routes = [
  ...
  { path: 'integrantes-setlist', component: SelecaoIntegrantesComponent },
